...
public class MathGameScript : MonoBehaviour
{
	...
	private void NewProblem()
	{
		...
		if (problem <= 3)
		{
			...
			{
				num1 = Mathf.RoundToInt(Random.Range(0f, 19f));
this.num2 = Mathf.RoundToInt(Random.Range(0f, 19f));
sign = Mathf.RoundToInt(Random.Range(0f, 2));
int x = Mathf.RoundToInt(Random.Range(1f, 19f));
int constant = Mathf.RoundToInt(Random.Range(-19f, 19f));

switch (sign)
{
    case 0:
        // Addition
        actualanswer = num1 + this.num2;
        solution = actualanswer.ToString();
    ...
    case 3:
        // Algebra equation 1
        int coefficient1 = Mathf.RoundToInt(Random.Range(1f, 19f));
        int constantTerm1 = Mathf.RoundToInt(Random.Range(-19f, 19f));
        int result1 = Mathf.RoundToInt(Random.Range(-19f, 19f));

        actualanswer = (result1 - constantTerm1) / coefficient1; // Corrected calculation
        solution = actualanswer.ToString();
        questionText.text = "SOLVE MATH Q" + problem + ": \n \n" + coefficient1 + "(" + x + ") + " + constantTerm1 + " = " + result1;
        break;
}
